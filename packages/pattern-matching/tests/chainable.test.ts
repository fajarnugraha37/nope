...
import { P, match } from "../src/index.ts";
...
describe("chainable methods", () => {
  describe("string compositions", () => {
    ...
    test(`P.string.startsWith(..).optional().select()`, () => {
      const f = (input?: string | number) =>
        match({ input })
          .with(
            {
    ...
    test("P.string.startsWith(..).endsWith(..)", () => {
      const f = (input?: string | number) =>
        match(input)
  ...
  describe("number compositions", () => {
    ...
    test(`P.number.int().positive().finite().between(..).optional().select(),`, () => {
      const f = (input?: string | number) =>
        match({ input })
          .with(
            {
  ...
  describe("bigint compositions", () => {
    ...
    test(`P.bigint.positive().between(..).optional().select(),`, () => {
      const f = (input?: string | bigint) =>
        match({ input })
          .with(
            {
  ...
  describe("and", () => {
    test("should infer the intersection of narrowed patterns", () => {
      const f = (input?: string | number) =>
        match(input)
          .with(
  ...
  describe("or", () => {
    test("should infer the union of narrowed patterns", () => {
      const f = (input?: string | number) =>
        match(input)
          .with(
