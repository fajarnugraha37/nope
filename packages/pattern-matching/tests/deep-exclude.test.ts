...
import { DeepExclude } from "../src/types/deep-exclude.ts";
import {
  DistributeMatchingUnions,
  FindUnions,
  FindUnionsMany,
} from "../src/types/distributed-union.ts";
import { Primitives, Equal, Expect } from "../src/types/helpers.ts";
import { IsMatching } from "../src/types/is-matching.ts";
import { BigUnion, Option, State } from "./resources/index.ts";
...
describe("DeepExclude", () => {
  ...
  describe("Objects", () => {
    test("should correctly exclude when it matches", () => {
      type cases = [
    ...
    test("if it doesn't match, it should leave the data structure untouched", () => {
      type cases = [
        Expect<
    ...
    test("should work with nested object and only distribute what is necessary", () => {
    ...
    test("should exclude the undefined case of optional properties when the pattern's key is also optional", () => {
      type input = {
        type: "a";
  ...
  describe("Tuples", () => {
    ...
    test("should work with nested tuples and only distribute what is necessary", () => {
      type cases = [
        Expect<Equal<DeepExclude<[["x" | "y"]], [["x"]]>, [["y"]]>>,
        Expect<
    ...
    test("should work with nested unary tuples", () => {
      type State = {};
  ...
  describe("Variadic", () => {
    test("should correctly turn variadic exclude into their opposite", () => {
    ...
    test("should only exclude if the pattern really matches", () => {
  ...
  describe("List", () => {
    ...
    test("should work with empty list patterns", () => {
  ...
  test("should work with big unions", () => {
    type cases = [
      Expect<
        Equal<
          DeepExclude<
  ...
  test("should work in common cases", () => {
    type cases = [
  ...
  describe("Multiple patterns", () => {
    test("should work when pattern is a union", () => {
      type cases = [
        Expect<
          Equal<
            DeepExclude<
  ...
  test("should work when `b` contains a union", () => {
    type t = Expect<
      Equal<
        DeepExclude<
          {
