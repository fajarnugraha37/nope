...
import type { SelectionType } from "../types/find-selected.js";
import type { Matcher, MatcherType, AnyMatcher } from "../types/pattern.js";
...
const isOptionalPattern = (
  ...
  return (
    isMatcher(x) && x[symbols.matcher]().matcherType === "optional"
  );
};
